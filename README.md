...
On Twitter (out-of-distribution), all models' performance drops because of noise and informal text, but Rule-Augmented XLM-RoBERTa remains the most robust, achieving the highest accuracy and F1-score.   

The rule-based and Naive Bayes baselines show larger performance drops, indicating their domain sensitivity.
...
kaggle: https://www.kaggle.com/datasets/mmmarchetti/tweets-dataset/code
